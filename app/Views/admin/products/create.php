                    ...
                    <form action="/index.php?url=admin/create" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <input type="number" name="price" class="form-control" placeholder="Ví dụ: 500000" min="0" required>
                            </div>
                            <div class="col-md-6 mb-3">
                            ...
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="category_id" class="form-select" required>
                                    ...
                                    <?php foreach ($categories as $cat) : ?>
                                        <option value="<?php echo (int) $cat['id']; ?>"><?php echo htmlspecialchars((string) $cat['name']); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                            <div class="col-md-6 mb-3">
                                ...
                                <select name="brand_id" class="form-select">
                                    ...
                                    <?php foreach ($brands as $brand) : ?>
                                        <option value="<?php echo (int) $brand['id']; ?>"><?php echo htmlspecialchars((string) $brand['name']); ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="form-text">Vui lòng chọn ảnh định dạng .jpg, .jpeg, .png hoặc .webp.</div>
                        </div>
